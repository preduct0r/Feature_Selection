...
#     mutual_info.loc[idx, 'mi'] = adjusted_mutual_info_score(X.loc[:,int(row[0])], y)
#
...
top_500_mi_features = mutual_info.index[:500]
with open(r"C:\Users\kotov-d\Documents\TASKS\feature_selection\top_500_mi_featur.pkl","wb") as f:
    pickle.dump(top_500_mi_features, f)
